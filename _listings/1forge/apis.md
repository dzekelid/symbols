...
- name: 1Forge Get Currency Symbols API
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/symbols/master/_listings/1forge/symbols-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/symbols/master/_listings/1forge/symbols-get-openapi.md
- name: 1Forge
  x-api-slug: 1forge
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/symbols/master/_listings/1forge/openapi.md
x-common:
- type: x-code
